...
(async () => {
  ...
  result.forEach((item) => {
      ...
      if (!fs.existsSync(imgPath)) {
        axios
          ...
          .then((res) => {
            ...
            downloaded++;
            console.log(`Downloaded ${downloaded}/${result.length}`);
          })
          .catch((error) => console.log(error.message, sticker.sprite));
      }
    });
    ...
    axios
      ...
      .catch((error) => console.log(`Thumbnail Error: ${error.message}`));
    ...
    axios
      ...
      .catch((error) => console.log(`Icon Error: ${error.message}`));
  });
